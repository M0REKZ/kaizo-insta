...
public:
	enum
	{
		...
		//+KZ
		CUSTOM_ENTTYPE_BALL,
		CUSTOM_ENTTYPE_FLAGBALL,
		CUSTOM_ENTTYPE_GRENADE_LAUNCHER,
		CUSTOM_ENTTYPE_MINE,
		CUSTOM_ENTTYPE_RANDOM_WEAPON,
		CUSTOM_ENTTYPE_KZPICKUP,
		CUSTOM_ENTTYPE_FDD_STABLE_PROJECTILE,
		CUSTOM_ENTTYPE_PORTAL_PROJECTILE,
		CUSTOM_ENTTYPE_PORTAL,
		CUSTOM_ENTTYPE_MINIGUN_PROJECTILE,
		CUSTOM_ENTTYPE_BLACKHOLE_AMMO,
		CUSTOM_ENTTYPE_BLACKHOLE,
		CUSTOM_ENTTYPE_VEHICLE_BASE,
		CUSTOM_ENTTYPE_HELICOPTER,
		CUSTOM_ENTTYPE_JET,
