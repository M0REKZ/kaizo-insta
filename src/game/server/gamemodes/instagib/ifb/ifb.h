#ifndef GAME_SERVER_GAMEMODES_IFB_H
#define GAME_SERVER_GAMEMODES_IFB_H

#include <game/server/gamemodes/instagib/fb.h>

class CIfbColumns : public CExtraColumns
{
public:
...
class CGameControllerIFB : public CGameControllerInstaFB
{
public:
	CGameControllerIFB(class CGameContext *pGameServer);
	~CGameControllerIFB();

    void OnCharacterSpawn(class CCharacter *pChr) override;
};
#endif // GAME_SERVER_GAMEMODES_IFB_H
