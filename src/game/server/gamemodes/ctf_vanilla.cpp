...
void CGameControllerCTFVanilla::Tick()
{
...
bool CGameControllerCTFVanilla::OnEntity(int Index, int x, int y, int Layer, int Flags, bool Initial, int Number)
{
...
void CGameControllerCTFVanilla::OnFlagReturn(CFlag *pFlag)
{
...
void CGameControllerCTFVanilla::OnFlagGrab(class CFlag *pFlag)
{
...
void CGameControllerCTFVanilla::OnFlagCapture(class CFlag *pFlag, float Time)
{
...
void CGameControllerCTFVanilla::FlagTick()
{
...
void CGameControllerCTFVanilla::Snap(int SnappingClient)
{
...
bool CGameControllerCTFVanilla::DoWincheckMatch()
{
